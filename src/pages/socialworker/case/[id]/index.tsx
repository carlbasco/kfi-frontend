...
const Case = () => {
  ...
  const { data, isValidating, error } = useSWR(id ? `/api/sw/case/${id}` : null)
  ...
  const [openNewAssessmentDialog, setOpenNewAssessmentDialog] = useState(false)
  const handleNewAssessmentDialog = () => {
    setOpenNewAssessmentDialog(!openNewAssessmentDialog)
  }
  ...
  return (
    <>
      ...
      <SocialWorkerLayout>
          ...
          <>
            <Box display="flex" justifyContent="flex-end">
              <Button
                ...
                variant="outlined"
                startIcon={<Edit />}
                onClick={() => router.push(`/socialworker/case/${id}/edit`)}
              >
                Edit Case
              </Button>
            </Box>
        ...
        {data && data?.status === 'pendingForAssessment' && id && (
          <>
            <Box display="flex" justifyContent="flex-end">
              <Button
                variant="outlined"
                color="secondary"
                onClick={handleNewAssessmentDialog}
              >
                Case Assessment
              </Button>
            </Box>
            <DialogAssessment
              id={id}
              open={openNewAssessmentDialog}
              handleDialog={handleNewAssessmentDialog}
            />
          </>
        )}
