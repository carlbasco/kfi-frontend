...
const SocialWorkerLayout = ({ children }: Props) => {
  ...
  useEffect(() => {
    router.pathname.startsWith('/socialworker/budget') && setValue(1)
    router.pathname.startsWith('/socialworker/progress') && setValue(2)
    router.pathname.startsWith('/socialworker/reports') && setValue(3)
  }, [router])
      ...
      <Box>
        ...
        <Container maxWidth="lg" css={styles.mainContent}>
          ...
          >
            ...
            >
              <LinkTab label="Case" href="/socialworker" />
              <LinkTab label="Budget" href="/socialworker/budget" />
              <LinkTab label="Progress Note" href="/socialworker/progress" />
              <LinkTab label="Reports" href="/socialworker/reports" />
            </Tabs>
          </Box>
          {children}
        </Container>
