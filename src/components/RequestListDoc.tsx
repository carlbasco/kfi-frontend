...
const RequestDocList = ({ data, date, user }: BudgetProps) => {
  return (
    <>
      <Document title="Budget List">
        <Page size="LETTER" style={styles.page}>
          ...
          <Text style={styles.title}>Type of Request List</Text>
          ...
          <View style={styles.tableBox}>
            <Table>
              <TableRow>
                ...
                <TableHeaderCell>Type of Request</TableHeaderCell>
                ...
                <TableRow key={item.id}>
                  <View style={styles.tableCellCustom}>
                    ...
                    <Text style={styles.txt}>
                      {item?.Background?.firstName} &nbsp;
                      {item?.Background?.lastName}
                    </Text>
                  </View>
                  <TableCellCenter>
                  ...
                  <TableCellCenter>
                    {item?.Assessment?.recommendation?.recommendationName}
                  </TableCellCenter>
                  <View
                    style={{
                      width: '20%',
                    ...
                    {data
                      ?.reduce(
                        (total: number, value: any) =>
                          total +
                          (value?.Budget?.amount ? value?.Budget?.amount : 0),
                        0
                      )
                      .toLocaleString()}
                  </Text>
